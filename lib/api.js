...
async function all(listFunction, filter = {}, options = {}) {
	...
	//TODO: Gestire errore listFunction
	if (!firstPage.data) return error(firstPage);
	...
	//TODO: Gestire errori singole chiamate
    (await Promise.all(pages)).forEach(p => { out = out.concat(data(p)) });
