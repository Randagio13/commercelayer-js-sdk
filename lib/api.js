        ...
        return api.client.call(apiRequest)
            ...
            .catch(error => {
                ...
                if (error.response.data && error.response.data.errors) {
                    ...
                    return Promise.reject(error.newError(api_error.status, api_error.title, api_error.detail, api_error.code))
                }
                else return Promise.reject(error.newError(error.response.status, error.response.statusText))
        })
    }
}
